...
namespace Stump.DofusProtocol.Types
{
    public class ActorRestrictionsInformations
    {
        ...
        public virtual void Serialize(IDataWriter writer)
        {
            ...
            flag2 = BooleanByteWrapper.SetFlag(flag2, 5, cantUseObject);
            flag2 = BooleanByteWrapper.SetFlag(flag2, 6, cantUseTaxCollector);
            flag2 = BooleanByteWrapper.SetFlag(flag2, 7, cantUseInteractive);
            writer.WriteByte(flag2);
            byte flag3 = 0;
            flag3 = BooleanByteWrapper.SetFlag(flag3, 0, cantSpeakToNPC);
            flag3 = BooleanByteWrapper.SetFlag(flag3, 1, cantChangeZone);
            flag3 = BooleanByteWrapper.SetFlag(flag3, 2, cantAttackMonster);
        ...
        public virtual void Deserialize(IDataReader reader)
        {
            ...
            cantUseObject = BooleanByteWrapper.GetFlag(flag2, 5);
            cantUseTaxCollector = BooleanByteWrapper.GetFlag(flag2, 6);
            cantUseInteractive = BooleanByteWrapper.GetFlag(flag2, 7);
            byte flag3 = reader.ReadByte();
            cantSpeakToNPC = BooleanByteWrapper.GetFlag(flag3, 0);
            cantChangeZone = BooleanByteWrapper.GetFlag(flag3, 1);
            cantAttackMonster = BooleanByteWrapper.GetFlag(flag3, 2);
        }
    }
}