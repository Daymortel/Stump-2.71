...
namespace Stump.DofusProtocol.Types
{
    public class GuildLogbookChestActivity : GuildLogbookEntryBasicInformation
    {
        ...
        public GuildLogbookChestActivity(uint id, double date, ulong playerId, string playerName, sbyte eventType, int quantity, Types.ObjectItemNotInContainer @object, int sourceTabId, int destinationTabId)
         : base(id, date)
        {
