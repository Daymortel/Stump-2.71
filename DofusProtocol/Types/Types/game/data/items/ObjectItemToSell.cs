...
namespace Stump.DofusProtocol.Types
{
    public class ObjectItemToSell : Item
    {
        ...
        public ObjectItemToSell(uint objectGID, IEnumerable<Types.ObjectEffect> effects, uint objectUID, uint quantity, ulong objectPrice)
        {
