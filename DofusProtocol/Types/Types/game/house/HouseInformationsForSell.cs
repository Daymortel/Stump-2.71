...
namespace Stump.DofusProtocol.Types
{
    public class HouseInformationsForSell
    {
        ...
        public HouseInformationsForSell(int instanceId, bool secondHand, uint modelId, Types.AccountTagInformation ownerTag, bool hasOwner, string ownerCharacterName, short worldX, short worldY, ushort subAreaId, sbyte nbRoom, sbyte nbChest, IEnumerable<int> skillListIds, bool isLocked, ulong price)
        {
