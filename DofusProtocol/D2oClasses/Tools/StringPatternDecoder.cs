...
namespace Stump.DofusProtocol.D2oClasses.Tools {
    ...
    public class InvalidPatternException : Exception {
        ...
        public InvalidPatternException (string message, int index) : base (message) {
            Index = index;
        }

        public InvalidPatternException (string message, Exception inner, int index) : base (message, inner) {
            Index = index;
        }

        protected InvalidPatternException (
            SerializationInfo info,
            StreamingContext context, int index) : base (info, context) {
            Index = index;
        }
    }
}