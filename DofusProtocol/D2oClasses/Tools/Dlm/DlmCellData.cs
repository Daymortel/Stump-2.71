...
namespace Stump.DofusProtocol.D2oClasses.Tools.Dlm
{
    public class DlmCellData : INotifyPropertyChanged
    {
        ...
        public sbyte LinkedZone
        {
            get { return _linkedZone; }
            set { _linkedZone = value; }
        }
        ...
        private static sbyte _linkedZone;
        ...
        {
            return Mov && !this.NonWalkableDuringFight && !FarmCell && !HavenbagCell;
        }
