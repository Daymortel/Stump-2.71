...
namespace Stump.DofusProtocol.D2oClasses
{
    ...
    public class Playlist : IDataObject, IIndexedData
    {
        ...
        public Boolean StartRandom
        {
            get { return this.startRandom; }
            set { this.startRandom = value; }
        }
        [D2OIgnore]
        public Boolean StartRandomOnce
        {
            get { return this.startRandomOnce; }
            set { this.startRandomOnce = value; }
        }
        [D2OIgnore]
        public int CrossfadeDuration
        {
            get { return this.crossfadeDuration; }
            set { this.crossfadeDuration = value; }
        }
        [D2OIgnore]
        public Boolean Random
        {
