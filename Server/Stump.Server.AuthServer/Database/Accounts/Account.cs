    ...
    public class Account : IAutoGeneratedRecord
    {
        ...
        public long AvailableBreedsFlag
        {
            ...
            set
            {
                ...
                m_availableBreeds.AddRange(Enum.GetValues(typeof(PlayableBreedEnum)).Cast<PlayableBreedEnum>().Where(IsBreedAvailable));
            }
        }
        ...
        public DateTime GoldSubscriptionEnd
        {
            get;
            set;
        }
        ...
        public List<PlayableBreedEnum> AvailableBreeds
        {
            ...
            set
            {
                ...
                m_availableBreedsFlag = (uint)value.Aggregate(0, (current, breedEnum) => current | (1 << ((int)breedEnum - 1)));
            }
        }
        ...
        public sbyte GetCharactersCountByWorld
        {
            get { return charactersCount.HasValue && charactersCount > 0 ? charactersCount.Value : (sbyte)0; }
        }
