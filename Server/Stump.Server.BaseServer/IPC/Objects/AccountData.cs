...
namespace Stump.Server.BaseServer.IPC.Objects
{
    ...
    public class AccountData
    {
        ...
        public int UserGroupId
        {
            get
            {
                return m_UserGroupId > (int)RoleEnum.Gold_Vip ? m_UserGroupId : GoldSubscriptionEndDate > DateTime.Now ? 3 : SubscriptionEndDate > DateTime.Now ? 2 : m_UserGroupId > 3 ? m_UserGroupId : 1;
            }
            set
            {
                m_UserGroupId = value;
        ...
        [ProtoMember(12)]
        public uint BreedFlags { get; set; }
        ...
        public List<PlayableBreedEnum> AvailableBreeds
        {
            get
            {
                ...
                m_breeds.AddRange(Enum.GetValues(typeof(PlayableBreedEnum)).Cast<PlayableBreedEnum>().Where(breed => CanUseBreed((int)breed)));
        ...
        [ProtoMember(14)]
        public int DeletedCharactersCount { get; set; }

        [ProtoMember(15)]
        public DateTime LastDeletedCharacterDate { get; set; }
        ...
        [ProtoMember(27)]
        public string RecievedRewards { get; set; }

        [ProtoMember(28)]
        public int LastDays { get; set; }

        [ProtoMember(29)]
        public DateTime GoldSubscriptionEndDate { get; set; }
        ...
        {
            get { return m_UserGroupId >= 2 ? true : GoldSubscriptionEndDate > DateTime.Now ? true : SubscriptionEndDate > DateTime.Now; }
        }
