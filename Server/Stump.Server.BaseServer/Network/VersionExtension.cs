...
namespace Stump.Server.BaseServer.Network
{
    ...
    public static class VersionExtension
    {
        ...
        /// </summary>
        [Variable(true)]
        public static Version ExpectedVersion = new Version(2, 61, 10, 17, (sbyte)BuildTypeEnum.RELEASE);

        /// <summary>
        /// Actual version
        /// </summary>
        [Variable(true)]
        public static string ActualProtocol = "";

        /// <summary>
        /// Required version
        /// </summary>
        [Variable(true)]
        public static string ProtocolRequired = "";
