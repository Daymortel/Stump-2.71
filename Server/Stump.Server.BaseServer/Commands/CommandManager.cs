...
namespace Stump.Server.BaseServer.Commands
{
    public class CommandManager : Singleton<CommandManager>
    {
        ...
        public void HandleCommand(TriggerBase trigger)
        {
            ...
            var command = cmd as CommandBase;
            ...
            } // TODO: crear un sistema Lang para este MSG de Mundo
            else if (command != null && command.RequiredRole == RoleEnum.Vip && trigger.UserRole == RoleEnum.Player)
            {
                trigger.ReplyError("Your character needs to be a VIP to be able to use this command \"{0}\".",  cmdstring);
            }
            else
            {
