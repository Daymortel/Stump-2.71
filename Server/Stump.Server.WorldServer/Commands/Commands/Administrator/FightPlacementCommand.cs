    ...
    public class FightPlacementShowCommand : InGameSubCommand
    {
        ...
        public override void Execute(GameTrigger trigger)
        {
            ...
            if (blue == null || blue.Length == 0)
            {
                ...
                trigger.Character.Client.Send(new DebugHighlightCellsMessage(Color.Blue.ToArgb(), blue.Select(x => (ushort)x.Id)));
            ...
            if (red == null || red.Length == 0)
            {
                ...
                trigger.Character.Client.Send(new DebugHighlightCellsMessage(Color.Red.ToArgb(), red.Select(x => (ushort)x.Id)));
        }
    }
    ...
    public class FightPlacementSetCommand : InGameSubCommand
    {
        ...
        public override void Execute(GameTrigger trigger)
        {
            ...
            WorldServer.Instance.IOTaskPool.ExecuteInContext(() =>
            {
                ...
                trigger.Character.Client.Send(new DebugHighlightCellsMessage(Color.Red.ToArgb(),
                    trigger.Character.Map.Record.RedFightCells.Select(x => (ushort)x)));
    ...
    public class FightPlacementAddCommand : InGameSubCommand
    {
        ...
        public override void Execute(GameTrigger trigger)
        {
            ...
            WorldServer.Instance.IOTaskPool.ExecuteInContext(() =>
            {
                ...
                trigger.Character.Client.Send(new DebugHighlightCellsMessage(Color.Blue.ToArgb(),
                    trigger.Character.Map.Record.BlueFightCells.Select(x => (ushort)x)));
                trigger.Character.Client.Send(new DebugHighlightCellsMessage(Color.Red.ToArgb(),
                    trigger.Character.Map.Record.RedFightCells.Select(x => (ushort)x)));
