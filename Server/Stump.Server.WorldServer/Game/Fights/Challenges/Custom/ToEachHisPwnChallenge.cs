...
namespace Stump.Server.WorldServer.Game.Fights.Challenges.Custom
{
    ...
    public class ToEachHisPwnChallenge : DefaultChallenge
    {
        ...
        public ToEachHisPwnChallenge(int id, IFight fight) : base(id, fight)
        {
            BonusMin = 60;
            BonusMax = 90;
        }
        ...
        protected override void OnWinnersDetermined(IFight fight, FightTeam winners, FightTeam losers, bool draw)
        {
            ...
            {
                UpdateStatus(ChallengeStatusEnum.FAILED_1, winner);
            }
