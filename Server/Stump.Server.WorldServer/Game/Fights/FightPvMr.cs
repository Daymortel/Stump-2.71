...
namespace Stump.Server.WorldServer.Game.Fights
{
    public class FightPvMr : Fight<FightPrismDefenderTeam, FightPrismAttackersTeam>
    {
        ...
        public override void StartFighting()
        {
            ...
            //PrismFighter.PrismNpc.Alliance.Clients.Send(new PrismFightRemovedMessage((ushort)PrismFighter.PrismNpc.SubArea.Id));
            ...
            foreach (var character in DefendersQueue)
            {
                ...
                defender.Area.ExecuteInContext(() =>
                {
                    ...
                    Map.Area.ExecuteInContext(() =>
                    {
                        ...
                        if (!DefendersQueue.All(x => DefendersTeamm.Fighters.OfType<CharacterFighter>().Any(y => y.Character == x)))
                            return;
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    //PrismHandler.SendPrismFightDefenderAddMessage(PrismFighter.PrismNpc.Alliance.Clients, PrismFighter.PrismNpc.SubArea, this, character);
        ...
        public bool RemoveDefender(Character character)
        {
            ...
            else
            {
                ...
                //PrismHandler.SendPrismFightDefenderRemoveMessage(PrismFighter.PrismNpc.Alliance.Clients, PrismFighter.PrismNpc.SubArea, this, character);
                result = true;
            }
        ...
        public TimeSpan GetPlacementTimeLeft(FightActor fighter)
        {
            ...
            else
            {
                ...
                {
                    if ((fighter.Team == AttackersTeam && IsAttackersPlacementPhase) || (fighter.Team == DefendersTeamm && IsDefendersPlacementPhase))
        ...
        public override bool CanChangePosition(FightActor fighter, Cell cell) => base.CanChangePosition(fighter, cell) && ((IsAttackersPlacementPhase && fighter.Team == AttackersTeam) || (IsDefendersPlacementPhase && fighter.Team == DefendersTeamm));
        ...
        protected override void OnFighterAdded(FightTeam team, FightActor actor)
        {
            ...
            if (State == FightState.Placement && team == AttackersTeam)
            {
                ...
                //if (fighter != null)
                //PrismHandler.SendPrismFightAttackerAddMessage(PrismFighter.PrismNpc.Alliance.Clients, PrismFighter.PrismNpc.SubArea, this, fighter.Character);
            }
        ...
        protected override void OnFighterRemoved(FightTeam team, FightActor actor)
        {
            ...
            {
                //PrismHandler.SendPrismFightAttackerRemoveMessage(PrismFighter.PrismNpc.Alliance.Clients, PrismFighter.PrismNpc.SubArea, this, ((CharacterFighter)actor).Character);
            }
