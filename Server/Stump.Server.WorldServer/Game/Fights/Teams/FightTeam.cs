...
namespace Stump.Server.WorldServer.Game.Fights.Teams
{
    public abstract class FightTeam
    {
        ...
        public void CheckAndAddWaves(long MapId, MonsterGroup group)
        {
            ...
            foreach (var wavemonster in m_waves)
            {
                ...
                var monsterFighter = new MonsterFighter(this, monster, (int)wavemonster.WaveNumber, (int)wavemonster.MinPartyMembers);
        ...
        //Fight.DefendersTeam == this ? Fight.DefendersTeam :  Fight.ChallengersTeam
        ...
        public bool AddFighter(FightActor actor)
        {
            ...
            lock (m_locker)
            {
                ...
                if (actor is CharacterFighter)
                {
                    ...
                    if (fighter.Character.Inventory.GetItems(CharacterInventoryPositionEnum.INVENTORY_POSITION_COMPANION).Length != 0 && this.Fight.FightType != FightTypeEnum.FIGHT_TYPE_AGRESSION && this.Fight.FightType != FightTypeEnum.FIGHT_TYPE_PVP_ARENA && this.Fight.FightType != FightTypeEnum.FIGHT_TYPE_PvT)
                    {
                        if (fighter.Character.CreateCompanion(this) != null)
                            this.AddFighter(fighter.Character.CreateCompanion(this));
                    }
