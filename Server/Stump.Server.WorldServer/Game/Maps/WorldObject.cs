...
namespace Stump.Server.WorldServer.Game.Maps
{
    public abstract class WorldObject : IDisposable
    {
        ...
        public bool IsGonnaChangeSubArea()
        {
            return NextMap == null || NextMap.SubArea.Id != SubArea.Id;
        }
        ...
        public bool HasChangedSubArea()
        {
            return LastMap == null || LastMap.SubArea.Id != SubArea.Id;
        }
