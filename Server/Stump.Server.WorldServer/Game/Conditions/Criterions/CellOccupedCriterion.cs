...
namespace Stump.Server.WorldServer.Game.Conditions.Criterions
{
    public class CellOccupedCriterion : Criterion
    {
        ...
        {
            var Target = character.Map.GetActor<Character>((int)character.Id);
            return Operator == ComparaisonOperatorEnum.EQUALS ? Target.Cell.Id == CellId : Target.Cell.Id != CellId;
        }
