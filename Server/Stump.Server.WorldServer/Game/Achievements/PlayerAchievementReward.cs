...
namespace Stump.Server.WorldServer.Game.Achievements
{
    ...
    public class PlayerAchievementReward
    {
        ...
        public IEnumerable<AchievementAchievedRewardable> GetRewardableAchievements()
        {
            ...
            {
                yield return new AchievementAchievedRewardable((ushort)item.Id, (ulong)Owner.Id, 1, m_rewardLevel);
            }
        }
        ...
        {
            if (m_rewardAchievementIds.Remove((ushort)achievement.Id))
                return m_rewardAchievements.Remove(achievement);
