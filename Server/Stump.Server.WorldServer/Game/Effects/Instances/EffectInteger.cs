...
namespace Stump.Server.WorldServer.Game.Effects.Instances
{
    ...
    public class EffectInteger : EffectBase
    {
        ...
        public EffectInteger(short id, int value, EffectBase effect) : base(id, effect)
        {
            m_value = value;
        }

        public EffectInteger(EffectsEnum id, int value) : this((short)id, value, new EffectBase())
        { }
