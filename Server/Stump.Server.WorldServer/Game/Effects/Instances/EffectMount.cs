...
namespace Stump.Server.WorldServer.Game.Effects.Instances
{
    ...
    public class EffectMount : EffectBase
    {
        ...
        public EffectMount(EffectMount copy) : this(copy.EffectId, copy.Id, copy.expirationDate, copy.model, copy.name, copy.owner, copy.level, copy.sex, copy.isRideable, copy.isFeconded, copy.isFecondationReady, copy.reproductionCount, copy.reproductionCountMax, copy.effects, copy.capacities, copy)
        {

        }

        public EffectMount(EffectsEnum effectId, double id, double expirationDate, uint model, string name, string owner, uint level, bool sex, bool isRideable, bool isFeconded, bool isFecondationReady, int reproductionCount, uint reproductionCountMax, List<EffectInteger> effects, List<uint> capacities, EffectBase effect) : base((short)effectId, effect)
        {
            this.id = id;
        ...
        public EffectMount(EffectsEnum effectId, double id, double expirationDate, uint model, string name, string owner, uint level, bool sex, bool isRideable, bool isFeconded, bool isFecondationReady, int reproductionCount, uint reproductionCountMax, List<EffectInteger> effects, List<uint> capacities) : base((short)effectId, new EffectBase())
        {
            this.id = id;
            this.expirationDate = expirationDate;
            this.model = model;
