...
namespace Stump.Server.WorldServer.Game.Effects.Instances
{
    ...
    public class EffectDate : EffectBase
    {
        ...
        public EffectDate(EffectsEnum id, DateTime date) : this((short)id, (short)date.Year, (short)date.Month, (short)date.Day, (short)date.Hour, (short)date.Minute, new EffectBase())
        { }
