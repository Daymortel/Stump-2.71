...
namespace Stump.Server.WorldServer.Game.Effects.Instances
{
    ...
    public class EffectDice : EffectInteger
    {
        ...
        public EffectDice(short id, int value, int dicenum, int diceface, EffectBase effect) : base(id, value, effect)
        {
            m_dicenum = dicenum;
            m_diceface = diceface;
        }
        ...
        public EffectDice(EffectsEnum effect, int value, int dicenum, int diceface) : this((short)effect, value, dicenum, diceface, new EffectBase())
        { }
