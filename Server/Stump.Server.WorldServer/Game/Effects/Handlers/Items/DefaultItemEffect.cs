...
namespace Stump.Server.WorldServer.Game.Effects.Handlers.Items
{
    ...
    public class DefaultItemEffect : ItemEffectHandler
    {
        ...
        #region Binds
         ...
         readonly Dictionary<PlayerFields, EffectComputeHandler> m_addMethods = new Dictionary
            <PlayerFields, EffectComputeHandler>
            {
                ...
                { PlayerFields.MeeleDamageDonePercent, AddMeeleDamage },
                { PlayerFields.MeeleDamageReceivedPercent, AddMeeleResistence },
         ...
         readonly Dictionary<PlayerFields, EffectComputeHandler> m_subMethods = new Dictionary
            <PlayerFields, EffectComputeHandler>
            {
                ...
                {PlayerFields.Weight, SubWeight},{ PlayerFields.MeeleDamageDonePercent, SubMeeleDamage },
                { PlayerFields.MeeleDamageReceivedPercent, SubMeeleResistence },
            ...
            new Dictionary<EffectsEnum, PlayerFields>
                {
                    ...
                    { EffectsEnum.Effect_MeeleDamageDonePercent, PlayerFields.MeeleDamageDonePercent },
                    { EffectsEnum.Effect_MeeleResistence, PlayerFields.MeeleDamageReceivedPercent },
            ...
            new Dictionary<EffectsEnum, PlayerFields>
                {
                    ...
                    { EffectsEnum.Effect_SubMeeleDamageDonePercent, PlayerFields.MeeleDamageDonePercent },
                    { EffectsEnum.Effect_SubMeeleResistence, PlayerFields.MeeleDamageReceivedPercent },
        ...
        {
            target.Stats[PlayerFields.MeeleDamageDonePercent].Equiped += (int)Math.Floor(effect.Value * efficiency);
        }

        private static void AddMeeleResistence(Character target, EffectInteger effect, bool isBoost, double efficiency)
        {
            target.Stats[PlayerFields.MeeleDamageReceivedPercent].Equiped += (int)Math.Floor(effect.Value * efficiency);
        }
