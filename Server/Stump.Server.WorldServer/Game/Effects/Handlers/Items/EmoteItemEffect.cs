...
namespace Stump.Server.WorldServer.Game.Effects.Handlers.Items
{
    ...
    {
        public EmoteItemEffect(EffectBase effect, Character target, BasePlayerItem item) : base(effect, target, item)
        { }

        public EmoteItemEffect(EffectBase effect, Character target, ItemSetTemplate itemSet, bool apply) : base(effect, target, itemSet, apply)
        { }
