...
namespace Stump.Server.WorldServer.Game.Effects.Handlers.Spells.Summon
{
    ...
    public class Double : SpellEffectHandler
    {
        ...
        public Double(EffectDice effect, FightActor caster, SpellCastHandler castHandler, Cell targetedCell, bool critical) : base(effect, caster, castHandler, targetedCell, critical)
        { }

        protected override bool InternalApply()
        {
            var summon = new SummonedClone(Fight.GetNextContextualId(), Caster, TargetedCell) { SummoningEffect = this };
