...
namespace Stump.Server.WorldServer.Game.Effects.Handlers.Spells.Buffs
{
    ...
    {
        public HealBuff(EffectDice effect, FightActor caster, SpellCastHandler castHandler, Cell targetedCell, bool critical) : base(effect, caster, castHandler, targetedCell, critical)
        {
        }
        ...
        void OnBuffTriggered(TriggerBuff buff, FightActor triggerer, BuffTriggerType trigger, object token)
        {
            ...
            if (Effect.EffectId == EffectsEnum.Effect_RestoreHPPercent)
                return;
