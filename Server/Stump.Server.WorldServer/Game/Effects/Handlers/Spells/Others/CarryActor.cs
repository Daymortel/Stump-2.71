...
namespace Stump.Server.WorldServer.Game.Effects.Handlers.Spells.Others
{
    ...
    {
        public CarryActor(EffectDice effect, FightActor caster, SpellCastHandler castHandler, Cell targetedCell, bool critical) : base(effect, caster, castHandler, targetedCell, critical)
        {
            base.Priority = 9999;
        }
    ...
    {
        public ThrowActor(EffectDice effect, FightActor caster, SpellCastHandler castHandler, Cell targetedCell, bool critical) : base(effect, caster, castHandler, targetedCell, critical)
        {
            base.Priority = 9998;
        }
