...
namespace Stump.Server.WorldServer.Game.Effects.Handlers.Spells.Move
{
    ...
    {
        public Rewind(EffectDice effect, FightActor caster, SpellCastHandler castHandler, Cell targetedCell, bool critical) : base(effect, caster, castHandler, targetedCell, critical)
        { }
        ...
        {
            if (buff != null && buff.Target != null && buff.Target.TurnStartPosition != null)
            {
