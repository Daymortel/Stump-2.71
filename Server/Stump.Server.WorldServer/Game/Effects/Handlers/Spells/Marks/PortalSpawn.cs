...
{
    [EffectHandler(EffectsEnum.Effect_PoseUnPortal)]
    public class PortalSpawn : SpellEffectHandler
    {
        ...
        protected override bool InternalApply()
        {
            ...
            var spell = new Spell((int)SpellIdEnum.SUCCESSFUL_TELEPORTAL_14597, 1);
    ...
    [EffectHandler(EffectsEnum.Effect_DesactiveUnPortal)]
