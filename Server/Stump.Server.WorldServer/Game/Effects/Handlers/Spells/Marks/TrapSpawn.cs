...
namespace Stump.Server.WorldServer.Game.Effects.Handlers.Spells.Marks
{
    ...
    public class TrapSpawn : SpellEffectHandler
    {
        ...
        public TrapSpawn(EffectDice effect, FightActor caster, SpellCastHandler castHandler, Cell targetedCell, bool critical) : base(effect, caster, castHandler, targetedCell, critical)
        { }
