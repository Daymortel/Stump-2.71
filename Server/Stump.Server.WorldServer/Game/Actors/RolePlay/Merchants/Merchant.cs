...
namespace Stump.Server.WorldServer.Game.Actors.RolePlay.Merchants
{
    public class Merchant : NamedActor
    {
        ...
        public Merchant(Character character)
        {
            ...
            look.AddSubLook(new SubActorLook(0, SubEntityBindingPointCategoryEnum.HOOK_POINT_CATEGORY_MERCHANT_BAG, new ActorLook { BonesID = BAG_SKIN }));
        ...
        public Merchant(WorldMapMerchantRecord record)
        {
            ...
            Position = new ObjectPosition(record.Map, record.Map.Cells[m_record.Cell], (DirectionsEnum)m_record.Direction);
        }
        ...
        public void Save(ORM.Database database)
        {
            WorldServer.Instance.IOTaskPool.AddMessage(() =>
            {
                ...
                {
                    logger.Error($"Error saving Character Merchant: {ex.Message}");
                }
            });
        }
        #endregion
