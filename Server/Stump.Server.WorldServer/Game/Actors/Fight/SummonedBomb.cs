...
namespace Stump.Server.WorldServer.Game.Actors.Fight
{
    public class SummonedBomb : FightActor, INamedActor, ICreature
    {
        ...
        {
            {2, SpellIdEnum.WALL_OF_FIRE_2825},
            {3, SpellIdEnum.WALL_OF_AIR_2829},
            {4, SpellIdEnum.WALL_OF_WATER_2833},
            {5, SpellIdEnum.EARTH_WALL_10064 },
        };
        ...
        public bool IsBoundWith(SummonedBomb bomb)
        {
            ...
            return dist > WallMinSize && dist <= (WallMaxSize + 1) && // comprobar la distancia
                MonsterBombTemplate == bomb.MonsterBombTemplate && // Las bombas son del mismo tipo.
                !IsCarried() && !bomb.IsCarried() && // No se llevan bombas
                Position.Point.IsOnSameLine(bomb.Position.Point) && // Las bombas están alineadas
        ...
        public override GameFightFighterInformations GetGameFightFighterInformations(WorldClient client = null)
        {
            return new GameFightMonsterInformations(
                ...
                creatureGenericId: (ushort)MonsterBombTemplate.MonsterId,
                creatureGrade: (sbyte)MonsterBombTemplate.GradeId,
                creatureLevel: (short)MonsterBombTemplate.Level);
        }

        public override FightTeamMemberInformations GetFightTeamMemberInformations()
        {
            return new FightTeamMemberMonsterInformations(id: Id, monsterId: MonsterBombTemplate.Template.Id, grade: (sbyte)MonsterBombTemplate.GradeId);
        }
