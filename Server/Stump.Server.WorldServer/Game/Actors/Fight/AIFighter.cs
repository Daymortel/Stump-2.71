...
namespace Stump.Server.WorldServer.Game.Actors.Fight
{
    ...
    {
        protected AIFighter(FightTeam team, IEnumerable<Spell> spells) : base(team)
        {
        ...
        protected AIFighter(FightTeam team, IEnumerable<Spell> spells, int identifier, MonsterGrade template = null) : base(team)
        {
