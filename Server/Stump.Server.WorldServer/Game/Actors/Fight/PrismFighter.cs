...
namespace Stump.Server.WorldServer.Game.Actors.Fight
{
    public sealed class PrismFighter : AIFighter
    {
        ...
        public PrismFighter(FightTeam team, PrismNpc prismNpc) : base(team, Enumerable.Empty<Spell>())
        {
            ...
            var grade = Singleton<MonsterManager>.Instance.GetMonsterGrade((int)MonsterIdEnum.PRISME_DALLIANCE_3451, 5);
        ...
        //                    FightPvMr.PvTAttackersPlacementPhaseTime / 100, 5), allyCharactersInformations, //TEST
        //        from x in OpposedTeam.Fighters.OfType<CharacterFighter>()
        //        select x.Character.GetCharacterMinimalPlusLookInformations());
        //}
    }
}