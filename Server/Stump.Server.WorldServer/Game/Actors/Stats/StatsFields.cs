...
namespace Stump.Server.WorldServer.Game.Actors.Stats
{
    ...
    public class StatsFields
    {
        ...
        [Variable]
        public static int InvoLimit = 6;

        #region >> Formulas

        private static readonly StatsFormulasHandler FormulasChanceDependant = owner => (short)(owner.Stats[PlayerFields.Chance] / 10d);

        private static readonly StatsFormulasHandler FormulasWisdomDependant = owner => (short)(owner.Stats[PlayerFields.Wisdom] / 10d);

        private static readonly StatsFormulasHandler FormulasAgilityDependant = owner => (short)(owner.Stats[PlayerFields.Agility] / 10d);
        ...
        public void Initialize(CharacterRecord record)
        {
            ...
            Fields.Add(PlayerFields.Prospecting, new StatsData(Owner, PlayerFields.Prospecting, record.Prospection, FormulasChanceDependant));
            Fields.Add(PlayerFields.AP, new StatsAP(Owner, record.AP, APLimit));
            Fields.Add(PlayerFields.MP, new StatsMP(Owner, record.MP, MPLimit));
            ...
            Fields.Add(PlayerFields.Health, new StatsHealth(Owner, record.BaseHealth, record.DamageTaken));
            ...
            Fields.Add(PlayerFields.SummonLimit, new StatsData(Owner, PlayerFields.SummonLimit, 1, InvoLimit, true));
        ...
        public void Initialize(Character character)
        {
            ...
            Fields.Add(PlayerFields.AP, new StatsAP(Owner, PA, APLimit));
            Fields.Add(PlayerFields.MP, new StatsMP(Owner, PM, MPLimit));
        ...
        public void Initialize(int Level)
        {
            int percentDamage = Level * 6;
            int damageBonus = (Level / 2);
            int DodgeAndTackle = (Level / 3);
            int PA = (Level / 28) < 6 ? 6 : (Level / 47);
            int PM = (Level / 47) < 3 ? 3 : (Level / 47);

            this.Fields = new Dictionary<PlayerFields, StatsData>();
            Fields.Add(PlayerFields.Initiative, new StatsInitiative(Owner, 0));
            Fields.Add(PlayerFields.Prospecting, new StatsData(Owner, PlayerFields.Prospecting, 0, FormulasChanceDependant));
            Fields.Add(PlayerFields.AP, new StatsAP(Owner, PA, APLimit));
            Fields.Add(PlayerFields.MP, new StatsMP(Owner, PM, MPLimit));
            Fields.Add(PlayerFields.Strength, new StatsData(Owner, PlayerFields.Strength, 0));
            Fields.Add(PlayerFields.Vitality, new StatsData(Owner, PlayerFields.Vitality, 0));
            this.Fields.Add(PlayerFields.Health, new StatsHealth(this.Owner, (Level * 10), 0));
            Fields.Add(PlayerFields.Wisdom, new StatsData(Owner, PlayerFields.Wisdom, 0));
            Fields.Add(PlayerFields.Chance, new StatsData(Owner, PlayerFields.Chance, 0));
            Fields.Add(PlayerFields.Agility, new StatsData(Owner, PlayerFields.Agility, 0));
            Fields.Add(PlayerFields.Intelligence, new StatsData(Owner, PlayerFields.Intelligence, 0));
            this.Fields.Add(PlayerFields.Range, new StatsData(this.Owner, PlayerFields.Range, Level / 100, StatsFields.RangeLimit));
            Fields.Add(PlayerFields.SummonLimit, new StatsData(Owner, PlayerFields.SummonLimit, 1, StatsFields.InvoLimit));
            Fields.Add(PlayerFields.DamageReflection, new StatsData(Owner, PlayerFields.DamageReflection, 0));
            Fields.Add(PlayerFields.CriticalHit, new StatsData(Owner, PlayerFields.CriticalHit, 0));
            Fields.Add(PlayerFields.CriticalMiss, new StatsData(Owner, PlayerFields.CriticalMiss, 0));
            Fields.Add(PlayerFields.HealBonus, new StatsData(Owner, PlayerFields.HealBonus, 0));
            ...
            Fields.Add(PlayerFields.TrapBonusPercent, new StatsData(Owner, PlayerFields.TrapBonusPercent, 0));
            Fields.Add(PlayerFields.PermanentDamagePercent, new StatsData(Owner, PlayerFields.PermanentDamagePercent, 0));
            this.Fields.Add(PlayerFields.TackleBlock, new StatsData(this.Owner, PlayerFields.TackleBlock, DodgeAndTackle, StatsFields.FormulasAgilityDependant));
            this.Fields.Add(PlayerFields.TackleEvade, new StatsData(this.Owner, PlayerFields.TackleEvade, DodgeAndTackle, StatsFields.FormulasAgilityDependant));
            Fields.Add(PlayerFields.APAttack, new StatsData(Owner, PlayerFields.APAttack, 0, FormulasWisdomDependant));
            Fields.Add(PlayerFields.MPAttack, new StatsData(Owner, PlayerFields.MPAttack, 0, FormulasWisdomDependant));
            Fields.Add(PlayerFields.PushDamageBonus, new StatsData(Owner, PlayerFields.PushDamageBonus, 0));
            Fields.Add(PlayerFields.CriticalDamageBonus, new StatsData(Owner, PlayerFields.CriticalDamageBonus, 0));
            ...
            Fields.Add(PlayerFields.AirDamageBonus, new StatsData(Owner, PlayerFields.AirDamageBonus, 0));
            Fields.Add(PlayerFields.FireDamageBonus, new StatsData(Owner, PlayerFields.FireDamageBonus, 0));
            this.Fields.Add(PlayerFields.DodgeAPProbability, new StatsData(this.Owner, PlayerFields.DodgeAPProbability, DodgeAndTackle, StatsFields.FormulasWisdomDependant));
            this.Fields.Add(PlayerFields.DodgeMPProbability, new StatsData(this.Owner, PlayerFields.DodgeMPProbability, DodgeAndTackle, StatsFields.FormulasWisdomDependant));
            Fields.Add(PlayerFields.NeutralResistPercent, new StatsData(Owner, PlayerFields.NeutralResistPercent, 12, ResistanceLimit));
            Fields.Add(PlayerFields.EarthResistPercent, new StatsData(Owner, PlayerFields.EarthResistPercent, 12, ResistanceLimit));
            Fields.Add(PlayerFields.WaterResistPercent, new StatsData(Owner, PlayerFields.WaterResistPercent, 12, ResistanceLimit));
            Fields.Add(PlayerFields.AirResistPercent, new StatsData(Owner, PlayerFields.AirResistPercent, 12, ResistanceLimit));
        ...
        public void Initialize(MonsterGrade record)
        {
            ...
            Fields.Add(PlayerFields.AP, new StatsAP(Owner, record.ActionPoints));
            Fields.Add(PlayerFields.MP, new StatsMP(Owner, record.MovementPoints));
            Fields.Add(PlayerFields.Strength, new StatsData(Owner, PlayerFields.Strength, record.Strength/*stats */));
            Fields.Add(PlayerFields.Vitality, new StatsData(Owner, PlayerFields.Vitality, record.Vitality/*stats*/));
            Fields.Add(PlayerFields.Health, new StatsHealth(Owner, record.LifePoints, 0));
            Fields.Add(PlayerFields.Wisdom, new StatsData(Owner, PlayerFields.Wisdom, record.Wisdom));
            Fields.Add(PlayerFields.Chance, new StatsData(Owner, PlayerFields.Chance, record.Chance /*stats*/));
            Fields.Add(PlayerFields.Agility, new StatsData(Owner, PlayerFields.Agility, record.Agility/*stats*/));
            Fields.Add(PlayerFields.Intelligence, new StatsData(Owner, PlayerFields.Intelligence, record.Intelligence/*stats*/));
            ...
            Fields.Add(PlayerFields.AirDamageBonus, new StatsData(Owner, PlayerFields.AirDamageBonus, 0));
            Fields.Add(PlayerFields.FireDamageBonus, new StatsData(Owner, PlayerFields.FireDamageBonus, 0));
            Fields.Add(PlayerFields.DodgeAPProbability, new StatsData(Owner, PlayerFields.DodgeAPProbability, record.PaDodge, FormulasWisdomDependant));
            Fields.Add(PlayerFields.DodgeMPProbability, new StatsData(Owner, PlayerFields.DodgeMPProbability, record.PmDodge, FormulasWisdomDependant));
            Fields.Add(PlayerFields.NeutralResistPercent, new StatsData(Owner, PlayerFields.NeutralResistPercent, record.NeutralResistance));
            Fields.Add(PlayerFields.EarthResistPercent, new StatsData(Owner, PlayerFields.EarthResistPercent, record.EarthResistance));
            Fields.Add(PlayerFields.WaterResistPercent, new StatsData(Owner, PlayerFields.WaterResistPercent, record.WaterResistance));
            Fields.Add(PlayerFields.AirResistPercent, new StatsData(Owner, PlayerFields.AirResistPercent, record.AirResistance));
            Fields.Add(PlayerFields.FireResistPercent, new StatsData(Owner, PlayerFields.FireResistPercent, record.FireResistance));
            Fields.Add(PlayerFields.NeutralElementReduction, new StatsData(Owner, PlayerFields.NeutralElementReduction, 0));
            Fields.Add(PlayerFields.EarthElementReduction, new StatsData(Owner, PlayerFields.EarthElementReduction, 0));
            Fields.Add(PlayerFields.WaterElementReduction, new StatsData(Owner, PlayerFields.WaterElementReduction, 0));
            Fields.Add(PlayerFields.AirElementReduction, new StatsData(Owner, PlayerFields.AirElementReduction, 0));
        ...
        public void Initialize(CustomIncarnationRecord record, CharacterRecord record_char)
        {
            // note : keep this order !

            Fields = new Dictionary<PlayerFields, StatsData>();

            Fields.Add(PlayerFields.Initiative, new StatsInitiative(Owner, record.Initiative));
            Fields.Add(PlayerFields.Prospecting, new StatsData(Owner, PlayerFields.Prospecting, 100 + record_char.Prospection, FormulasChanceDependant));
            Fields.Add(PlayerFields.AP, new StatsAP(Owner, record.ActionPoints + record_char.AP, APLimit));
            Fields.Add(PlayerFields.MP, new StatsMP(Owner, record.MovementPoints + record_char.MP, MPLimit));
            Fields.Add(PlayerFields.Strength, new StatsData(Owner, PlayerFields.Strength, record.Strength + record_char.Strength) { Additional = record_char.PermanentAddedStrength });
            Fields.Add(PlayerFields.Vitality, new StatsData(Owner, PlayerFields.Vitality, record.Vitality + record_char.Vitality) { Additional = record_char.PermanentAddedVitality });
            Fields.Add(PlayerFields.Health, new StatsHealth(Owner, (int)record.LifePoints + record_char.BaseHealth, record_char.DamageTaken));
            Fields.Add(PlayerFields.Wisdom, new StatsData(Owner, PlayerFields.Wisdom, record.Wisdom + record_char.Wisdom) { Additional = record_char.PermanentAddedWisdom });
            Fields.Add(PlayerFields.Chance, new StatsData(Owner, PlayerFields.Chance, record.Chance + record_char.Chance) { Additional = record_char.PermanentAddedChance });
            Fields.Add(PlayerFields.Agility, new StatsData(Owner, PlayerFields.Agility, record.Agility + record_char.Agility) { Additional = record_char.PermanentAddedAgility });
            Fields.Add(PlayerFields.Intelligence, new StatsData(Owner, PlayerFields.Intelligence, record.Intelligence + record_char.Intelligence) { Additional = record_char.PermanentAddedIntelligence });
            Fields.Add(PlayerFields.Range, new StatsData(Owner, PlayerFields.Range, record.Range, RangeLimit, true));
            Fields.Add(PlayerFields.SummonLimit, new StatsData(Owner, PlayerFields.SummonLimit, 1 + record.Summons, InvoLimit, true));
            Fields.Add(PlayerFields.DamageReflection, new StatsData(Owner, PlayerFields.DamageReflection, 0));
            Fields.Add(PlayerFields.CriticalHit, new StatsData(Owner, PlayerFields.CriticalHit, record.CriticalHit));
            Fields.Add(PlayerFields.CriticalMiss, new StatsData(Owner, PlayerFields.CriticalMiss, 0));
            Fields.Add(PlayerFields.HealBonus, new StatsData(Owner, PlayerFields.HealBonus, 0));
            Fields.Add(PlayerFields.DamageBonus, new StatsData(Owner, PlayerFields.DamageBonus, 0));
            Fields.Add(PlayerFields.WeaponDamageBonus, new StatsData(Owner, PlayerFields.WeaponDamageBonus, 0));
            ...
            Fields.Add(PlayerFields.CriticalDamageBonus, new StatsData(Owner, PlayerFields.CriticalDamageBonus, 0));
            Fields.Add(PlayerFields.NeutralDamageBonus, new StatsData(Owner, PlayerFields.NeutralDamageBonus, 0));
            Fields.Add(PlayerFields.EarthDamageBonus, new StatsData(Owner, PlayerFields.EarthDamageBonus, record.EarthDamageBonus));
            Fields.Add(PlayerFields.WaterDamageBonus, new StatsData(Owner, PlayerFields.WaterDamageBonus, record.WaterDamageBonus));
            Fields.Add(PlayerFields.AirDamageBonus, new StatsData(Owner, PlayerFields.AirDamageBonus, record.AirDamageBonus));
            Fields.Add(PlayerFields.FireDamageBonus, new StatsData(Owner, PlayerFields.FireDamageBonus, record.FireDamageBonus));
            Fields.Add(PlayerFields.DodgeAPProbability, new StatsData(Owner, PlayerFields.DodgeAPProbability, record.PaDodge, FormulasWisdomDependant));
            Fields.Add(PlayerFields.DodgeMPProbability, new StatsData(Owner, PlayerFields.DodgeMPProbability, record.PmDodge, FormulasWisdomDependant));
            Fields.Add(PlayerFields.NeutralResistPercent, new StatsData(Owner, PlayerFields.NeutralResistPercent, record.NeutralResistancePercent));
            Fields.Add(PlayerFields.EarthResistPercent, new StatsData(Owner, PlayerFields.EarthResistPercent, record.EarthResistancePercent));
            Fields.Add(PlayerFields.WaterResistPercent, new StatsData(Owner, PlayerFields.WaterResistPercent, record.WaterResistancePercent));
            Fields.Add(PlayerFields.AirResistPercent, new StatsData(Owner, PlayerFields.AirResistPercent, record.AirResistancePercent));
            Fields.Add(PlayerFields.FireResistPercent, new StatsData(Owner, PlayerFields.FireResistPercent, record.FireResistancePercent));
            Fields.Add(PlayerFields.NeutralElementReduction, new StatsData(Owner, PlayerFields.NeutralElementReduction, record.NeutralElementReduction));
            Fields.Add(PlayerFields.EarthElementReduction, new StatsData(Owner, PlayerFields.EarthElementReduction, record.EarthElementReduction));
            Fields.Add(PlayerFields.WaterElementReduction, new StatsData(Owner, PlayerFields.WaterElementReduction, record.WaterElementReduction));
            Fields.Add(PlayerFields.AirElementReduction, new StatsData(Owner, PlayerFields.AirElementReduction, record.AirElementReduction));
            Fields.Add(PlayerFields.FireElementReduction, new StatsData(Owner, PlayerFields.FireElementReduction, record.FireElementReduction));
            Fields.Add(PlayerFields.PushDamageReduction, new StatsData(Owner, PlayerFields.PushDamageReduction, 0));
            Fields.Add(PlayerFields.CriticalDamageReduction, new StatsData(Owner, PlayerFields.CriticalDamageReduction, 0));
            Fields.Add(PlayerFields.PvpNeutralResistPercent, new StatsData(Owner, PlayerFields.PvpNeutralResistPercent, 0));
            Fields.Add(PlayerFields.PvpEarthResistPercent, new StatsData(Owner, PlayerFields.PvpEarthResistPercent, 0));
