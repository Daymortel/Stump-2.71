...
namespace Stump.Server.WorldServer.Game.Interactives.Skills
{
    ...
    {
        public SkillZaapTeleport(int id, InteractiveSkillTemplate record, InteractiveObject interactiveObject) : base(id, record, interactiveObject)
        { }

        public SkillZaapTeleport(int id, InteractiveCustomSkillRecord record, InteractiveObject interactiveObject) : base(id, record.Template, interactiveObject)
        { }
