...
namespace Stump.Server.WorldServer.Game.Interactives.Skills
{
    ...
    {
        public SkillConsultMerchant(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject) : base(id, skillTemplate, interactiveObject)
        {
        }
