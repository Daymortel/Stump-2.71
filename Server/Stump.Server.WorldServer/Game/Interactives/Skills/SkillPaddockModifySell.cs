...
{
    [Discriminator("PaddockModifySell", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class PaddockModifySell : CustomSkill
    {
       
        public PaddockModifySell(int id, InteractiveCustomSkillRecord record, InteractiveObject interactiveObject)
