...
//{
//    [SpellCastHandler(SpellIdEnum.DAKID_5894)]
...
//        }
//    }
//    [SpellCastHandler(SpellIdEnum.DAGOB_5882)]
...
//    [SpellCastHandler(SpellIdEnum.NYAN_5892)]
...
//    [SpellCastHandler(SpellIdEnum.OUGAA_5890)]
...
//            if (Fight.GetAllFighters(Caster.Position.Point.GetAdjacentCellsFix().Select(x => Caster.Map.GetCell(x.CellId))).Count() > 0)
//            {
...
//    [SpellCastHandler(SpellIdEnum.PROXIMA_5878)]
...
//        {
//            var fighters = Fight.GetAllFighters(Caster.Position.Point.GetAdjacentCellsFix().Select(x => Caster.Map.GetCell(x.CellId)));
...
//    [SpellCastHandler(SpellIdEnum.DOMO_5945)]
...
//    [SpellCastHandler(SpellIdEnum.AROUMB_5912)]
...
//    [SpellCastHandler(SpellIdEnum.HOSKAR_5893)]
...
//        {
//            if (Fight.GetAllFighters(Caster.Position.Point.GetAdjacentCellsFix().Select(x => Caster.Map.Cells[x.CellId])).Where(x => x.Team == Fight.DefendersTeam).Count() == 0)
//            {
//                var buffs = Caster.GetBuffs().Where(x => x.GetType() == typeof(StatBuff));
//                if (buffs.Count() > 0)
//                {
...
//    [SpellCastHandler(SpellIdEnum.ULTRAM_5916)]
