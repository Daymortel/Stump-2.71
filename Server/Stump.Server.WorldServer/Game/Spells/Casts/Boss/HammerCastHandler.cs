...
{
    [SpellCastHandler(SpellIdEnum.TEERTS_HAMMER_896)]
    [SpellCastHandler(SpellIdEnum.BENANDGERRIZ_HAMMER_901)]
    public class HammerCastHandler : DefaultSpellCastHandler
    {
        ...
        public override void Execute()
        {
            ...
            //Base Effects
            Handlers[0].Apply();
            Handlers[Spell.Id == (int)SpellIdEnum.BENANDGERRIZ_HAMMER_901 ? 1 : (Critical ? 2 : 1)].Apply();
            ...
            if (Spell.Id == (int)SpellIdEnum.BENANDGERRIZ_HAMMER_901)
                Handlers[4].Apply();
            else
            {
        ...
        private void SpellBuffTrigger(TriggerBuff buff, FightActor triggerrer, BuffTriggerType trigger, object token)
        {
            ...
            Handlers[Spell.Id == (int)SpellIdEnum.BENANDGERRIZ_HAMMER_901 ? 2 : 1].Apply(); //Remove Effects
            Handlers[Spell.Id == (int)SpellIdEnum.BENANDGERRIZ_HAMMER_901 ? 5 : 4].Apply(); //Dispell State
        }
    }
}
