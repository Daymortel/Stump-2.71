...
{
    [SpellCastHandler(SpellIdEnum.PROSPECTING_13350)]
    public class ProspectingHandler : DefaultSpellCastHandler //By Kenshin Version 2.61.10
    {
        public ProspectingHandler(SpellCastInformations cast) : base(cast)
        { }
