...
namespace Stump.Server.WorldServer.Game.Items.Player
{
    public class Bank : ItemsStorage<BankItem>
    {
        ...
        public void LoadRecord()
        {
            ...
            Items = WorldServer.Instance.DBAccessor.Database.Query<BankItemRecord>(string.Format(BankItemRelator.FetchByOwner, Owner.Account.Id)).ToDictionary(x => x.Id, x => new BankItem(Owner, x));
        }
