...
namespace Stump.Server.WorldServer.Game.Items.Player.Custom
{
    ...
    public class UseFollower : BasePlayerItem
    {
        ...
        public UseFollower(Character owner, PlayerItemRecord record) : base(owner, record)
        { }
        ...
        public override uint UseItem(int amount = 1, Cell targetCell = null, Character target = null)
        {
            ...
            if (boostItem == null)
            {
                logger.Error(string.Format("Follower {0} has boostItem {1} but it doesn't exist", Template.Id, criterion));
                return 0;
            }
