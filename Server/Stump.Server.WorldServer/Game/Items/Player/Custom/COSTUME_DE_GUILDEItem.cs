...
namespace Stump.Server.WorldServer.Game.Items.Player.Custom
{
    ...
    public class COSTUME_DE_GUILDEItem : BasePlayerItem
    {
        public COSTUME_DE_GUILDEItem(Character owner, PlayerItemRecord record)
            : base(owner, record)
        {
        }
        ...
        public override ActorLook UpdateItemSkin(ActorLook characterLook)
        {
            if (IsEquiped())
            {
                ...
                if (Owner.Guild != null )
                {
                    ...
                    if(!Owner.Inventory.Any(entry => entry.Template.Id == 13240 && entry.IsEquiped()))
            ...
            else
            {
                ...
                if (Owner.Guild != null && !Owner.Inventory.Any(entry => entry.Template.Id == 13240 && entry.IsEquiped()))
                {
