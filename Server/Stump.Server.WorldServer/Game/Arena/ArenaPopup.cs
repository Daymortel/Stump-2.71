    ...
    public class ArenaPopup : Notification
    {
        ...
        public override void Display()
        {
            ...
            if (Character.ArenaMode == 1)
                ContextHandler.SendGameRolePlayArenaRegistrationStatusMessage(Character.Client, false, PvpArenaStepEnum.ARENA_STEP_WAITING_FIGHT, PvpArenaTypeEnum.ARENA_TYPE_1VS1);
            else
                ContextHandler.SendGameRolePlayArenaRegistrationStatusMessage(Character.Client, false, PvpArenaStepEnum.ARENA_STEP_WAITING_FIGHT, PvpArenaTypeEnum.ARENA_TYPE_3VS3_TEAM);
