...
namespace Stump.Server.WorldServer.AI.Fights.Spells
{
    public class SpellIdentifier
    {
        ...
        public static SpellCategory GetSpellCategories(SpellLevelTemplate spellLevel) => spellLevel.Effects.Aggregate(SpellCategory.None, (current, effect) => current | GetEffectCategories(effect));
        ...
        public static SpellCategory GetEffectCategories(EffectDice effect)
        {
            switch (effect.EffectId)
            {
                ...
                case EffectsEnum.Effect_2794:
                    ...
                    var triggerEffectIds = new List<EffectsEnum>
                    {
                        EffectsEnum.Effect_TriggerBuff,
                        EffectsEnum.Effect_TriggerBuff_793,
                        ...
                        EffectsEnum.Effect_2792,
                        EffectsEnum.Effect_2793,
                        EffectsEnum.Effect_2794
                    };

                    if (spell.Effects.Any(x => triggerEffectIds.Contains(x.EffectId) && x.DiceNum == effect.SpellId))
                        return SpellCategory.None;
