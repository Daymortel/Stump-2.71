...
namespace Stump.Server.WorldServer.AI.Fights.Brain.Custom.Boss
{
    ...
    {
        public ObsidiantreBrain(AIFighter fighter) : base(fighter)
        {
    ...
    public class PougnetteBrain : Brain
    {
        ...
        public PougnetteBrain(AIFighter fighter) : base(fighter)
        {
        ...
        private void OnTurnStarted(IFight obj, FightActor actor)
        {
            ...
            {
                Fighter.CastAutoSpell(new Spell((int)SpellIdEnum.THWACK_2602, 1), Fighter.Cell);
                turnos++;
            }
        }
        ...
        public override void Play()
        {
            foreach (var spell in Fighter.Spells.Values)
            {
                ...
                Fighter.CastSpell(new Spell((int)SpellIdEnum.SHUTOUT_2601, 1), Fighter.Cell);
