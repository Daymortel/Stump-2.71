...
{
    [BrainIdentifier((int)MonsterIdEnum.PAVOIS_5372)]
    [BrainIdentifier((int)MonsterIdEnum.PAVOIS_5910)]
    public class PavoisBrain : Brain
    {
        ...
        void OnFighterAdded(FightTeam team, FightActor fighter)
        {
            ...
            Fighter.CastAutoSpell(new Spell((int)SpellIdEnum.PAVISE_13046, 1), Fighter.Cell);
        }
    }
}