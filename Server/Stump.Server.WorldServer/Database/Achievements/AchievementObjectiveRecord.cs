...
namespace Stump.Server.WorldServer.Database.Achievements
{
    ...
    [D2OClass("AchievementObjective", "com.ankamagames.dofus.datacenter.quest"), TableName("achievements_objectives")]
    public class AchievementObjectiveRecord : IAutoGeneratedRecord, ISaveIntercepter, IAssignedByD2O
    {
        ...
        [Ignore]
        public AchievementTemplate Achievement => m_achievement ?? (m_achievement = Singleton<AchievementManager>.Instance.TryGetAchievement(AchievementId));
        ...
        {
            return AbstractCriterion == null ? new AchievementObjective((ushort)Id, 0) : AbstractCriterion.GetAchievementObjective(this, player);
        }
        ...
        public AchievementStartedObjective GetAchievementStartedObjective(PlayerAchievement player)
        {
            ...
            return new AchievementStartedObjective(Id, AbstractCriterion.MaxValue, AbstractCriterion.GetPlayerValue(player));
        }
    }
}