...
namespace Stump.Server.WorldServer.Database.Tinsel
{
    ...
    public class TitleRecord : IAssignedByD2O, IAutoGeneratedRecord
    {
        ...
        public uint NameMaleId { get; set; }

        public uint NameFemaleId { get; set; }

        public string Name
        {
            get { return m_name ?? (m_name = TextManager.Instance.GetText(NameMaleId)); }
            set { m_name = value; }
        }
        ...
        public void AssignFields(object d2oObject)
        {
            ...
            Id = title.id;
            NameMaleId = title.nameMaleId;
            NameFemaleId = title.nameFemaleId;
