        ...
        public override bool Execute(Npc npc, Character character)
        {
            ...
            else
            {
                if (Side != 3)
                {
                    ...
                    {
                        character.ChangeAlignementSide((AlignmentSideEnum)Side);
                        //if (Side == 3 && !character.Vip)
                        //{

                        //    switch (character.Account.Lang)
                        //    {
                        //        case "fr":
                        //            character.SendServerMessage($"Juste pour VIP!");
                        //            break;
                        //        case "es":
                        //           character.SendServerMessage($"¡Sólo para VIP!");
                        //            break;
                        //        case "en":
                        //            character.SendServerMessage($"Just for VIP!");
                        //            break;
                        //        default:
                        //            character.SendServerMessage("Apenas para VIP!");
                        //            break;
                        //    }
                        //    return false;
                        //}
