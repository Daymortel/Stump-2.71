...
{
    [Discriminator("TeleportToDung", typeof(NpcReply), typeof(NpcReplyRecord))]
    public class TeleportToDungReply : NpcReply
    {

        public TeleportToDungReply(NpcReplyRecord record) : base(record)
        {
        }
