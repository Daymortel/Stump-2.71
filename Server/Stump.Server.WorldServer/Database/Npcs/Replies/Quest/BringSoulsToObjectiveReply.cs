...
{
    public class BringSoulsToObjectiveReply : QuestObjective
    {
        public BringSoulsToObjectiveReply(Character character, QuestObjectiveTemplate template, bool finished, int npcId, int monsterId, int amount) : base(character, template, finished)
        {
        ...
        public BringSoulsToObjectiveReply(Character character, QuestObjectiveTemplate template, QuestObjectiveStatus status, int npcId, int monsterId, int amount) : base(character, template, status)
        {
            Npc = NpcManager.Instance.GetNpcTemplate(npcId);
            Amount = amount;
            Monster = MonsterManager.Instance.GetTemplate(monsterId);
