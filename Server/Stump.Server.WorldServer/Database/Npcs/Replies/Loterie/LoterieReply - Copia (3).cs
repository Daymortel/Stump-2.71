...
//{
//    [Discriminator("Loteria150", typeof(NpcReply), new System.Type[]{typeof(NpcReplyRecord)})]
//    class Loterie150Reply : NpcReply
//    {
//        public Loterie150Reply(NpcReplyRecord record) : base(record)
//        {
//        }
...
//                List<int> m_Loterie = new List<int>() { 0, 0, 100, 25, 0, 0, 10, 20, 20, 25, 10, 10, 10, 1, 5, 50, 20, 0, 0, 10, 20, 60, 20, 10, 1, 1, 1, 30, 150 };
