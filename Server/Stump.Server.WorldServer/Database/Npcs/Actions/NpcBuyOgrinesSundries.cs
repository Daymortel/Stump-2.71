...
namespace Stump.Server.WorldServer.Database.Npcs.Actions
{
    ...
    public class NpcBuyOgrinesSundries : NpcActionDatabase
    {
        public const string Discriminator = "ShopSundries";
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();

        private List<NpcItem> m_items;
        private ItemTemplate m_token;

        public NpcBuyOgrinesSundries(NpcActionRecord record) : base(record)
        { }
        ...
        public override NpcActionTypeEnum[] ActionType
        {
            ...
            {
                return new[] {
                NpcActionTypeEnum.ACTION_BUY_SUNDRIES,
            };
            }
        }
