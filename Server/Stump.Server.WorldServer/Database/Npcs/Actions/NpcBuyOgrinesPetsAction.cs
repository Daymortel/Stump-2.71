...
namespace Stump.Server.WorldServer.Database.Npcs.Actions
{
    ...
    public class NpcBuyOgrinesPetsAction : NpcActionDatabase
    {
        public const string Discriminator = "ShopPets";
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();

        private List<NpcItem> m_items;
        private ItemTemplate m_token;

        public NpcBuyOgrinesPetsAction(NpcActionRecord record)
            : base(record)
        {
        }
        ...
        {
            get { return new[] {
                NpcActionTypeEnum.ACTION_BUY_PETS,
            }; }
        }
