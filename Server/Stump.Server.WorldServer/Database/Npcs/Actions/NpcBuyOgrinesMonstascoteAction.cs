...
namespace Stump.Server.WorldServer.Database.Npcs.Actions
{
    ...
    public class NpcBuyOgrinesMontascoteAction : NpcActionDatabase
    {
        public const string Discriminator = "ShopMontascote";
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();

        private List<NpcItem> m_items;
        private ItemTemplate m_token;

        public NpcBuyOgrinesMontascoteAction(NpcActionRecord record)
            : base(record)
        {
        }
        ...
        {
            get { return new[] {
                NpcActionTypeEnum.ACTION_BUY_MONTASCOTE,
            }; }
        }
