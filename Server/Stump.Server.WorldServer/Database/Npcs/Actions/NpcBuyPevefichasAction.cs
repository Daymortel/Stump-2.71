...
namespace Stump.Server.WorldServer.Database.Npcs.Actions
{
    ...
    public class NpcBuyPevefichasAction : NpcActionDatabase
    {
        public const string Discriminator = "ShopPevefichas";
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();

        private List<NpcItem> m_items;
        private ItemTemplate m_token;

        public NpcBuyPevefichasAction(NpcActionRecord record)
            : base(record)
        {
        }
        ...
        {
            get { return new[] {
                NpcActionTypeEnum.ACTION_SELL_PEVEFICHAS,
            }; }
        }
