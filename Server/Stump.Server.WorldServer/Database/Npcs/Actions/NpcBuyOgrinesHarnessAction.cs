...
namespace Stump.Server.WorldServer.Database.Npcs.Actions
{
    ...
    public class NpcBuyOgrinesHarnessAction : NpcActionDatabase
    {
        public const string Discriminator = "ShopHarness";
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();

        private List<NpcItem> m_items;
        private ItemTemplate m_token;

        public NpcBuyOgrinesHarnessAction(NpcActionRecord record)
            : base(record)
        {
        }
        ...
        {
            get { return new[] {
                NpcActionTypeEnum.ACTION_BUY_HARNESS,
            }; }
        }
