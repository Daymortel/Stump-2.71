...
namespace Stump.Server.WorldServer.Database.Npcs.Actions
{
    ...
    public class NpcBuyKolifichasAction : NpcActionDatabase
    {
        public const string Discriminator = "ShopKolifichas";
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();

        private List<NpcItem> m_items;
        private ItemTemplate m_token;

        public NpcBuyKolifichasAction(NpcActionRecord record) : base(record)
        {
        }
        ...
        {
            get { return new[] {
                NpcActionTypeEnum.ACTION_BUY_KOLOSSOKENS,
            }; }
        }
