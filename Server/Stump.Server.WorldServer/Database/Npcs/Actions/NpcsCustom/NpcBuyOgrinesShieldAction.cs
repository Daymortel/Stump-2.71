...
namespace Stump.Server.WorldServer.Database.Npcs.Actions
{
    ...
    public class NpcBuyOgrinesShieldAction : NpcActionDatabase
    {
        public const string Discriminator = "ShopShield";
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();

        private List<NpcItem> m_items;
        private ItemTemplate m_token;

        public NpcBuyOgrinesShieldAction(NpcActionRecord record) : base(record)
        {
        }
        ...
        {
            get { return new[] {
                NpcActionTypeEnum.ACTION_BUY_SHIELD,
            }; }
        }
