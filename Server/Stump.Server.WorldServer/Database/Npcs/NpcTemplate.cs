...
namespace Stump.Server.WorldServer.Database.Npcs
{
    ...
    public class NpcTemplate : IAssignedByD2O, ISaveIntercepter, IAutoGeneratedRecord
    {
        ...
        [Ignore]
        public int[][] DialogMessagesId { get; set; }
        ...
        [Ignore]
        public int[][] DialogRepliesId { get; set; }
        ...
        [Ignore]
        public uint[] ActionsIds { get; set; }
        ...
        public string LookAsString
        {
            get
            {
                if (m_entityLook != null && m_entityLook.ToString() != "null")
                {
            ...
            set
            {
                ...
                {
                    m_entityLook = ActorLook.Parse(value);
                }
