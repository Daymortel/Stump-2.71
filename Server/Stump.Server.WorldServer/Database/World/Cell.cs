...
namespace Stump.Server.WorldServer.Database.World
{
    ...
    public class Cell
    {
        ...
        //public bool NonWalkableDuringFight =>  ((LosMov & 2) != 0 && (LosMov & 4) >> 2 == 1);
        ...
        public bool IsRightChange => this.versionMap >= 9 ? this.versionMap >= 10 ? (MoveZone & 2048) != 0 : (MoveZone & 1024) != 0 : (MapChangeData & 1) > 0;

        public bool IsLeftChange => this.versionMap >= 9 ? this.versionMap >= 10 ? (MoveZone & 4096) != 0: (MoveZone & 2048) != 0:(MapChangeData & 16) > 0;

        public bool IsTopChange => this.versionMap >= 9 ? this.versionMap >= 10 ? (MoveZone & 512) != 0: (MoveZone & 256) != 0: (MapChangeData & 64) > 0;

        public bool IsBotChange => this.versionMap >= 9 ? this.versionMap >= 10 ? (MoveZone & 1024) != 0 : (MoveZone & 512) != 0: (MapChangeData & 4) > 0;
        */
        public bool IsTopChange_test => (MapChangeData % 64 == 0);
        public bool IsLeftChange_test => (MapChangeData % 8 == 0);
        public bool IsRightChange_test => (MapChangeData % 2 == 0);
        public bool IsBotChange_test => (MapChangeData % 1 == 0);
