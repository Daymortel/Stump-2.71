...
namespace Stump.Server.WorldServer.Database.Monsters
{
    ...
    public class MonsterStaticSpawn : IAutoGeneratedRecord
    {
        ...
        {
            get { return m_tpmap ?? (m_tpmap = Game.World.Instance.GetMap(TeleportMapId)); }
            set
            {
                m_tpmap = value;
        ...
        [Ignore]
        public Cell TeleportCell
        {
            get { return m_tpcell ?? (m_tpcell = Map.GetCell(TeleportCellId)); }
            set
            {
                m_tpcell = value;
                TeleportCellId = value.Id;
            }
        }

        [NullString]
        public uint? TeleportDirection
        {
            get;
            set;
        }
