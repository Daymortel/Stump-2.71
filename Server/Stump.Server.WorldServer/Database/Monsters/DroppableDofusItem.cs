...
{
    public class DroppableDofusItemRelator
    {
        public static string FetchQuery = "SELECT * FROM monsters_drops_dofus";
        public static string FetchByOwner = "SELECT * FROM monsters_drops_dofus WHERE MonsterOwnerId = {0}";
    }

    [TableName("monsters_drops_dofus")]
    public class DroppableDofusItem
    {
