...
namespace Stump.Server.WorldServer.Database.Monsters
{
    ...
    public class MonsterDungeonSpawn : IAutoGeneratedRecord
    {
        ...
        {
            var cell = TeleportCell == null ? TeleportMap.GetRandomFreeCell() : TeleportMap.Cells[(int)TeleportCell];
            return !TeleportEvent ? null : new ObjectPosition(TeleportMap, cell, TeleportMap.GetRandomDirection());
        }
    }
