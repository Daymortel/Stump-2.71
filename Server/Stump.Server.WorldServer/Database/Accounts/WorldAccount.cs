...
namespace Stump.Server.WorldServer.Database.Accounts
{
    ...
    public class WorldAccount : IAutoGeneratedRecord
    {
        ...
        public DateTime LastLoterieDateVip { get; set; }

        public DateTime LastDungeonDate { get; set; }

        //public int CountItensStaff { get; set; }

        //public DateTime LastCountItenStaff { get; set; }

        public long TotalGameTimeInSeconds { get; set; }
