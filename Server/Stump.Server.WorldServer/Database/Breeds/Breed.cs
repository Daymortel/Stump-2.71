...
namespace Stump.Server.WorldServer.Database.Breeds
{
    ...
    public class Breed : IAssignedByD2O, ISaveIntercepter, IAutoGeneratedRecord
    {
        ...
        private string m_breedInitSpellsIdCSV;
        private string m_breedTemporisInitSpellsIdCSV;
        ...
        private uint[] m_breedInitSpellsId;
        private uint[] m_breedTemporisInitSpellsId;
        ...
        public string BreedInitSpellsIdCSV
        {
            get { return m_breedInitSpellsIdCSV; }
            set
            {
                m_breedInitSpellsIdCSV = value;
                m_breedInitSpellsId = BreedInitSpellsIdCSV?.FromCSV<uint>(",");
            }
        }

        public string BreedTemporisInitSpellsIdCSV
        {
            get { return m_breedTemporisInitSpellsIdCSV; }
            set
            {
                m_breedTemporisInitSpellsIdCSV = value;
                m_breedTemporisInitSpellsId = BreedTemporisInitSpellsIdCSV?.FromCSV<uint>(",");
            }
        }

        [Ignore]
        public uint[] BreedInitSpellsIds
        {
            get { return m_breedInitSpellsId ?? (m_breedInitSpellsId = BreedInitSpellsIdCSV?.FromCSV<uint>(",")); }
            set
            {
                m_breedInitSpellsId = value;
                BreedInitSpellsIdCSV = value.ToCSV(",");
            }
        }

        [Ignore]
        public uint[] BreedTemporisInitSpellsIds
        {
            get { return m_breedTemporisInitSpellsId ?? (m_breedTemporisInitSpellsId = BreedTemporisInitSpellsIdCSV?.FromCSV<uint>(",")); }
            set
            {
                m_breedTemporisInitSpellsId = value;
                BreedTemporisInitSpellsIdCSV = value.ToCSV(",");
            }
        }
