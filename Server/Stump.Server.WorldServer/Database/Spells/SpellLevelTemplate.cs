...
namespace Stump.Server.WorldServer.Database.Spells
{
    ...
    public class SpellLevelTemplate : IAssignedByD2O, ISaveIntercepter, IAutoGeneratedRecord
    {
        ...
        [Ignore]
        public int[] StatesRequired { get; set; }
        ...
        public Boolean NeedFreeCell { get; set; }

        public Boolean NeedFreeTrapCell { get; set; }

        public Boolean NeedVisibleEntity { get; set; }

        public Boolean NeedCellWithoutPortal { get; set; }

        public Boolean PortalProjectionForbidden { get; set; }

        public Boolean NeedTakenCell { get; set; }

        public Boolean RangeCanBeBoosted { get; set; }
        ...
        public Boolean CriticalFailureEndsTurn { get; set; }

        public Boolean HideEffects { get; set; }

        public Boolean Hidden { get; set; }

        public Boolean PlayAnimation { get; set; }
        ...
        public void AssignFields(object d2oObject)
        {
            ...
            NeedCellWithoutPortal = spell.needCellWithoutPortal;
            PortalProjectionForbidden = spell.portalProjectionForbidden;
            ...
            Hidden = spell.hidden;
            PlayAnimation = spell.playAnimation;
            StatesCriterion = spell.statesCriterion;
            ...
            //PreviewZones = spell.previewZones;
        }
