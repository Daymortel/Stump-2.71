...
namespace Stump.Server.WorldServer.Database.Quests
{
    ...
    public class QuestObjectiveTemplate : IAutoGeneratedRecord, IAssignedByD2O
    {
        ...
        public int TriggeredByObjectiveId { get; set; }

        public bool IsTriggeredByObjective { get; set; }

        public long MapId { get; set; }

        [Ignore]
        public QuestObjectiveType RealType { get; set; }

        [Ignore]
        public QuestObjectiveTemplate[] ObjectivesToTrigger { get; set; }
        ...
        public Game.Quests.QuestObjective GenerateObjective(Character character)
        {
            switch (Type)
            {
                ...
                case QuestObjectiveTypeEnum.ESCORT:
                    return new EscortMonstersObjective(character, this, false, Parameter0, Parameter1);
                ...
                case QuestObjectiveTypeEnum.DEFEAT_MULTI:
                    return new DefeatMonstersObjective(character, this, false, Parameter0, Parameter1);
                case QuestObjectiveTypeEnum.DEFEAT_TWO_MONSTERS_ONE_FIGHT:
                    return new DefeatMonstersObjective(character, this, false, Parameter0, Parameter1);
        ...
        public void AssignFields(object d2oObject)
        {
            ...
            CoordsX = objective.Coords is null ? 0 : objective.Coords.x;
            CoordsY = objective.Coords is null ? 0 : objective.Coords.y;
            MapId = (long)objective.mapId;
        }
    }
}