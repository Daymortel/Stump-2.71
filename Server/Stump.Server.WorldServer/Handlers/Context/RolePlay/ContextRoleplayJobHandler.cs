...
namespace Stump.Server.WorldServer.Handlers.Context.RolePlay
{
    public partial class ContextRoleplayHandler
    {
        ...
        {
            client.Send(new JobMultiCraftAvailableSkillsMessage(enabled, (ulong)character.Id, skills.Select(x => (ushort)x.Id)));
        }
        ...
        {
            client.Send(new JobExperienceOtherPlayerUpdateMessage(job.GetJobExperience(), (ushort)character.Id));
        }
