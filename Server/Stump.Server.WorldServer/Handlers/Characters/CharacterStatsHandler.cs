...
namespace Stump.Server.WorldServer.Handlers.Characters
{
    public partial class CharacterHandler
    {
        ...
        {
            client.Send(new CharacterLevelUpInformationMessage(level, character.Name, (ulong)character.Id));
        }
        ...
        {
            client.Send(new CharacterExperienceGainMessage((ulong)experienceCharacter, (ulong)experienceMount, (ulong)experienceGuild,
