...
//                return 0;
//            double temp = m_occurenceDict.Count;

//            var temp3 = m_occurenceDict.Values.OrderBy(x => x).ElementAt((int)temp - 1);
//            var temp2 = ( temp3* percentile);
//            //if (temp2 > 0.50)
//                //temp2 = (double)temp2 / (double)((double)temp2 / (double)0.50);
//            return temp2;
...
namespace Stump.Core.Collections
{
    public class LimitedOccurenceCounter<T> : IEnumerable<KeyValuePair<T, int>>
    {
        ...
        public int GetPercentile(double percentile)
        {
            ...
            //return m_occurenceDict.Values.OrderBy(x => x).ElementAt((int)((m_occurenceDict.Count - 1) * percentile));
            return m_occurenceDict.Values.OrderBy(x => x).ElementAt((int)((m_occurenceDict.Count - 1)) * (int)(percentile / 100));
        }
